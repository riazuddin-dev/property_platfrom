  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <div className="mb-10">
        ...
        <p className="text-slate-400 mt-2">Manage your owner account</p>
      </div>
      ...
      <div className="bg-slate-900 rounded-3xl p-12 border border-slate-700">
        <div className="flex flex-col lg:flex-row gap-16 items-center lg:items-start">
          ...
          <div className="flex-shrink-0">
            <div className="w-64 h-64 rounded-3xl overflow-hidden border-4 border-teal-500 shadow-2xl">
              <img
            ...
            <div className="mt-6 flex justify-center">
              <span className="inline-flex items-center gap-2 px-6 py-2.5 bg-amber-500/10 text-amber-400 rounded-full text-sm font-medium">
                <Building2 size={18} /> Property Owner
              </span>
            </div>
          </div>
          ...
          <div className="flex-1 space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-10">
              <div>
                ...
                <p className="text-4xl font-bold">{user?.name || session?.user?.name}</p>
              </div>
              ...
              <div>
                ...
                <span className="inline-block px-8 py-3 bg-amber-500/10 text-amber-400 rounded-2xl font-semibold text-lg capitalize">
                  {user?.role || "owner"}
                </span>
              </div>
      ...
      <div className="mt-8 text-center">
        <button className="btn bg-teal-500 hover:bg-teal-600 text-white px-10 py-4 rounded-2xl text-lg font-medium flex items-center gap-3 mx-auto">
